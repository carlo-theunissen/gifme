...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'video_upload.ffprobe' => 'getVideoUpload_FfprobeService',
            'video_upload.post_video_validator' => 'getVideoUpload_PostVideoValidatorService',
            'video_upload.s3bucket' => 'getVideoUpload_S3bucketService',
            'video_upload.upload_handler' => 'getVideoUpload_UploadHandlerService',
            'video_upload.video_validator' => 'getVideoUpload_VideoValidatorService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jE+rsB382W', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fPdl-rFkKF', 0, 'CiLeJgYi0E82HU+ImCWSH8', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('oneup_uploader.validation', array(0 => 'video_upload.video_validator', 1 => 'onValidate'), 0);
        $instance->addListenerService('oneup_uploader.post_persist', array(0 => 'video_upload.post_video_validator', 1 => 'onUpload'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'gifParty', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_222cdd83c305cd350b239cedc670853e6db45e99ba1a6f26ed6c2bc20153b855');
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/api' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'), 'max_age' => 3600)), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false, 'forced_allow_origin_value' => NULL));
    }
    ...
    {
        return $this->services['oneup_uploader.controller.gallery'] = new \Oneup\UploaderBundle\Controller\DropzoneController($this, $this->get('oneup_uploader.storage.gallery'), new \Oneup\UploaderBundle\Uploader\ErrorHandler\DropzoneErrorHandler(), array('frontend' => 'dropzone', 'storage' => array('directory' => ($this->targetDirs[3].'/app/../uploads'), 'service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 9223372036854775807, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid', 'root_folder' => false), 'gallery');
    }
    ...
    {
        return $this->services['oneup_uploader.storage.gallery'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage(($this->targetDirs[3].'/app/../uploads'));
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('gallery' => 33554432.0));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/VideoUploadBundle/Resources/views'), 'VideoUpload');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4346318e3d2f6c38cc0db1d9038320845f9e0d33');
    }
    ...
    /**
     * Gets the 'video_upload.ffprobe' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VideoUploadBundle\DependencyInjection\FFProbe A VideoUploadBundle\DependencyInjection\FFProbe instance
     */
    protected function getVideoUpload_FfprobeService()
    {
        return $this->services['video_upload.ffprobe'] = new \VideoUploadBundle\DependencyInjection\FFProbe(($this->targetDirs[5].'/ffmpeg/ffprobe'));
    }

    /**
     * Gets the 'video_upload.post_video_validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VideoUploadBundle\Validators\PostcheckVideo A VideoUploadBundle\Validators\PostcheckVideo instance
     */
    protected function getVideoUpload_PostVideoValidatorService()
    {
        return $this->services['video_upload.post_video_validator'] = new \VideoUploadBundle\Validators\PostcheckVideo($this->get('video_upload.ffprobe'), array(0 => 'vp9', 1 => 'mpeg1video', 2 => 'mpeg2video', 3 => 'mpeg4', 4 => 'h264', 5 => 'h261', 6 => 'flv1', 7 => 'theora'), $this->get('video_upload.upload_handler'));
    }

    /**
     * Gets the 'video_upload.s3bucket' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VideoUploadBundle\DependencyInjection\SDKS3Bucket A VideoUploadBundle\DependencyInjection\SDKS3Bucket instance
     */
    protected function getVideoUpload_S3bucketService()
    {
        return $this->services['video_upload.s3bucket'] = new \VideoUploadBundle\DependencyInjection\SDKS3Bucket('eu-central-1', 'AKIAIIHAAFZ4CZXTLF7A', 'V+pIq5W5rZhDtSkjrAWCj/gHWcbR7kDgxLU8uzPs', 'gifcreatoruat');
    }

    /**
     * Gets the 'video_upload.upload_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VideoUploadBundle\DependencyInjection\S3UploadHandler A VideoUploadBundle\DependencyInjection\S3UploadHandler instance
     */
    protected function getVideoUpload_UploadHandlerService()
    {
        return $this->services['video_upload.upload_handler'] = new \VideoUploadBundle\DependencyInjection\S3UploadHandler($this->get('video_upload.s3bucket'));
    }

    /**
     * Gets the 'video_upload.video_validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VideoUploadBundle\Validators\VideoValidator A VideoUploadBundle\Validators\VideoValidator instance
     */
    protected function getVideoUpload_VideoValidatorService()
    {
        return $this->services['video_upload.video_validator'] = new \VideoUploadBundle\Validators\VideoValidator(20);
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('npjT1bCTd2', 0, 'CiLeJgYi0E82HU+ImCWSH8', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('592af1d5a45049.98035716')), true);
    ...
    private $loadedDynamicParameters = array(
        ...
        'video_upload.ffprobe_command' => false,
        'oneup_uploader.config.gallery' => false,
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'VideoUploadBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/VideoUploadBundle'),
                    'namespace' => 'VideoUploadBundle',
                ),
            ...
            case 'video_upload.ffprobe_command': $value = ($this->targetDirs[5].'/ffmpeg/ffprobe'); break;
            case 'oneup_uploader.config.gallery': $value = array(
                'frontend' => 'dropzone',
                'storage' => array(
                    'directory' => ($this->targetDirs[3].'/app/../uploads/'),
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VideoUploadBundle' => 'VideoUploadBundle\\VideoUploadBundle',
            ...
            'secret' => '4346318e3d2f6c38cc0db1d9038320845f9e0d33',
            'bucket_name' => 'gifcreatoruat',
            ...
            'kernel.secret' => '4346318e3d2f6c38cc0db1d9038320845f9e0d33',
            ...
            'video_upload.accepted_formats' => array(
                0 => 'vp9',
                1 => 'mpeg1video',
                2 => 'mpeg2video',
                3 => 'mpeg4',
